      ...
      <div className={`${font.className} bg-[#67D9FD] text-lg`}>
        ...
        <div className="max-w-7xl mx-auto mb-16 md:mb-24 px-4">
          <div className="grid md:grid-cols-2 gap-8">
            <div>
              ...
              <div className="flex items-center space-x-6 justify-center md:justify-start">
                ...
                <a
                  ...
                  title="Dexscreener"
                >
                  <svg fill="#000" fillRule="evenodd" viewBox="0 0 252 300" xmlns="http://www.w3.org/2000/svg" className="size-7">
                ...
                <a
                  ...
                  title="Dextools"
                >
                  <svg fill="none" viewBox="0 -0.058 754.779 867.058" xmlns="http://www.w3.org/2000/svg" className="size-7">
                    <path
                      clipRule="evenodd"
            ...
            <Image src="/chad.gif" width={445} height={480} alt="Yes. Chad" className="w-80 h-auto mx-auto block" unoptimized />
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto mb-12 px-4">
          <div className="grid md:grid-cols-2 gap-4 bg-white rounded-2xl border-2 border-black">
            ...
            <div className="px-4 py-8">
              <Image src="/cover-1.jpg" width={605} height={700} className="w-auto h-auto mx-auto" alt="Yes Chad Meme" />
            </div>
          </div>
        </div>
        <div className="max-w-7xl mx-auto mb-12 px-4">
