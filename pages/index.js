...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className={`${font.className} bg-[#67D9FD] text-[#07354a] text-lg`}>
        <div className="bg-[#2B8CAD]">
          <div className="max-w-7xl mx-auto mb-16 md:mb-24 px-4 flex items-center justify-between">
            ...
            <div className="flex justify-center gap-4 font-semibold flex-wrap mb-4">
              <a
                href={telegramUrl}
                className="flex items-center bg-amber-100 hover:bg-white px-2 py-1 sm:px-4 sm:py-2 rounded-md outline outline-2 outline-[#07354a] shadow-solid-primary shadow-[#07354a]"
                target="_blank"
                title="Telegram"
              >
                <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="size-5" fill="currentColor">
        ...
        <div className="max-w-7xl mx-auto mb-16 md:mb-24 px-4">
          <div class="grid md:grid-cols-2 gap-8">
            <div>
              <h1 className="text-white text-4xl md:text-7xl font-black mb-6 [text-shadow:_2px_4px_0_var(--tw-shadow-color)] shadow-[#07354a]">
                Welcome, Chad
              </h1>
              ...
              <div className="flex items-center space-x-6 justify-center md:justify-start text-[#07354a]">
                <a
                  href={birdEyeUrl}
                  className="flex items-center bg-amber-100 hover:bg-white px-4 py-2 rounded-md outline outline-2 outline-[#07354a] shadow-solid-primary shadow-[#07354a]"
                  target="_blank"
                  title="Birdeye"
                >
                ...
                <a
                  ...
                  title="Dexscreener"
                >
                  <svg fill="#07354a" fillRule="evenodd" viewBox="0 0 252 300" xmlns="http://www.w3.org/2000/svg" class="size-7">
                ...
                <a
                  ...
                  title="Dextools"
                >
                  <svg fill="none" viewBox="0 -0.058 754.779 867.058" xmlns="http://www.w3.org/2000/svg" class="size-7">
                    <path
                      clipRule="evenodd"
            ...
            <Image src="/chad.png" width={512} height={512} alt="Yes. Chad" className="w-80 h-auto mx-auto block" />
          </div>
        </div>
        <div className="max-w-7xl mx-auto mb-12 px-4">
          <h2 className="text-white text-4xl md:text-7xl font-black mb-6 [text-shadow:_2px_4px_0_var(--tw-shadow-color)] shadow-[#07354a] text-center">
            Chadnomics
          </h2>
          <div class="grid md:grid-cols-2 gap-4 text-center">
            <div className="bg-white px-4 py-8 rounded-2xl ring-1 ring-cyan-200">
              ...
              <div class="flex items-center">
                ...
                <button
                  type="button"
                  className="h-10 flex items-center ml-2 px-2 py-1 rounded-md bg-white border-2 border-[#07354a] text-center"
                  onClick={handleCopy}
                  disabled={isDisabled}
                >
                  {buttonText}
        ...
        <div className="max-w-7xl mx-auto mb-12 px-4">
          <div class="grid md:grid-cols-2 gap-4 bg-white rounded-2xl ring-1 ring-cyan-200">
              ...
              <div>
                ...
                <div className="text-xl leading-8 space-y-8">
                  ...
                  <p>
                    <a
                      href={swapUrl}
                      className="bg-amber-100 hover:bg-white px-4 py-2 rounded-md outline outline-2 outline-[#07354a] font-semibold shadow-solid-primary shadow-[#07354a]"
                      target="_blank"
                    >
            ...
            <div className="px-4 py-8">
              <Image src="/cover-1.jpg" width={605} height={700} className="w-auto h-auto mx-auto" priority="low" alt="Yes Chad Meme" />
            </div>
          </div>
        </div>
