      ...
      <div className={`${font.className} bg-[#67D9FD] text-lg`}>
        <div className="bg-[#2B8CAD]">
          <div className="max-w-7xl mx-auto mb-16 md:mb-24 px-4 flex items-center justify-between">
            <div>
              <Image src="/chad.png" width={120} height={120} className="w-16 sm:w-20 md:w-24 h-auto block mx-auto py-4" alt="Yes Chad Logo" />
            </div>
            ...
            <div>
              ...
              <div className="flex items-center space-x-6 justify-center md:justify-start">
                ...
                <a
                  ...
                  title="Dexscreener"
                >
                  <svg fill="#000" fill-rule="evenodd" viewBox="0 0 252 300" xmlns="http://www.w3.org/2000/svg" class="size-7">
