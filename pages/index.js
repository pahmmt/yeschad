      ...
      <div className="max-w-7xl mx-auto mb-16 md:mb-24 px-4">
        <div className="mb-4">
          <Image
            ...
            width={445}
            height={480}
            className="w-36 h-auto block mx-auto"
            alt=""
            unoptimized
          />
        </div>
        ...
        <div class="grid md:grid-cols-2 gap-8">
          <div>
            ...
            <div className="text-xl leading-8 font-semibold mb-6">
              Yes Chad has become an emblem of internet culture&#39;s ability to
              take something potentially divisive, strip it of its original
              context, and turn it into a universal symbol of internet coolness
              and humor. It&#39;s like watching humanity&#39;s collective psyche
              evolve in real-time, one “yes” at a time.
            </div>
            ...
            <div>
              ...
              <div className="text-xl leading-8 space-y-8">
                <p>
                  ...
                  August 2019, thanks to a tweet by @yachs_91, it quickly became
                  an internet sensation, embodying hyper-masculine indifference
                  or, in some cases, a satirical take on racial and cultural
                  stereotypes.
                </p>
                <p>
                  ...
                  this fray.” It&#39;s been adopted across various platforms for
                  its simplicity and the humorous, often ironic, acknowledgment
